...
pcx_fox_help[] = {
        ...
        "9🎩: Se oni ludis nur unu 9-karton, oni kalkulas la venkanton "
        "kvazaŭ ĝia emblemo estus la emblemo de la dekreta karto.\n"
        ...
        "9🎩: If only one 9-card is played in the trick then that card is "
        "scored as if it was in the decree suit.\n"
